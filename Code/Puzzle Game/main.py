...
class Game: 
    ...
    def __init__(self):
        ...
        self.start_game = False ##To check if the game is running
    ...
    def new(self):
        ...
        self.buttons_list = []
        self.buttons_list.append(Button(775, 100, 200, 50, "Shuffle", GREEN, BLACK))
        self.buttons_list.append(Button(775, 170, 200, 50, "Reset", GREEN, BLACK))
        self.draw_tiles()
                    ...
                    for col, tile in enumerate(tiles):
                        if tile.click(mouse_x,mouse_y):
                            ...
                            if tile.right() and self.tiles_grid[row][col +1] == 0:
                                self.tiles_grid[row][col], self.tiles_grid[row][col + 1] = self.tiles_grid[row][col + 1], self.tiles_grid[row][col] ##Change position of tiles
